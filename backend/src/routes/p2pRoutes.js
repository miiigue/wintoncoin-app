...
router.get('/api/p2p/payment-methods', verifyUserToken, async (req, res) => {
    try {
...
// Crear oferta P2P
router.post('/api/p2p/offers', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
    const {
        offerType,
        currency,
        pricePerBlue,
...
// Listar ofertas P2P
router.get('/api/p2p/offers', verifyUserToken, async (req, res) => {
...
// Mis ofertas P2P
router.get('/api/p2p/offers/mine', verifyUserToken, async (req, res) => {
...
// Crear orden P2P
router.post('/api/p2p/orders', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
...
router.get('/api/p2p/orders', verifyUserToken, async (req, res) => {
    const username = req.user.username;
...
// Marcar como pagado
router.post('/api/p2p/orders/:id/mark-paid', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
...
router.post('/api/p2p/orders/:id/release', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
    const orderId = req.params.id;
    const username = req.user.username;
    const client = await pool.connect();
    try {
...
router.post('/api/p2p/orders/:id/cancel', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
    const orderId = req.params.id;
    const username = req.user.username;
    const client = await pool.connect();
    try {
...
router.post('/api/p2p/orders/:id/request-extension', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
    const orderId = req.params.id;
    const username = req.user.username;
    const client = await pool.connect();
    try {
...
// Disputa
router.post('/api/p2p/orders/:id/dispute', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
    const orderId = req.params.id;
...
router.post('/api/p2p/orders/:id/rate', verifyUserToken, requireAcceptedLegalForAuthenticatedUser(), async (req, res) => {
    const orderId = req.params.id;
...
router.post('/api/admin/p2p/disputes/:id/resolve', verifyAdminToken, async (req, res) => {
