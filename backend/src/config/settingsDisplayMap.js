...
const SETTINGS_DISPLAY_MAP = {
    ...
    'debt_cycle_days': 'Duración del Ciclo de Compromisos RED — Días',
    'debt_cycle_hours': 'Duración del Ciclo de Compromisos RED — Horas',
    'debt_cycle_minutes': 'Duración del Ciclo de Compromisos RED — Minutos',
